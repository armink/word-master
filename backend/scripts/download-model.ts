...
try {
  ...
  console.log('\n解决方案：')
  console.log('  1. 若有代理，运行: HTTPS_PROXY=http://127.0.0.1:7890 npx tsx scripts/download-model.ts')
  console.log('  2. 若 hf-mirror.com 不可达，尝试: HF_MIRROR=https://huggingface.co npx tsx scripts/download-model.ts')
